...
public abstract class CustomAbstractUserDetailsAuthenticationProvider implements
...
public Authentication authenticate(Authentication authentication)
	throws AuthenticationException {
Assert.isInstanceOf(UsernamePasswordAuthcodeAuthenticationToken.class, authentication,
		messages.getMessage(
...
UsernamePasswordAuthcodeAuthenticationToken result = new UsernamePasswordAuthcodeAuthenticationToken(
...
return (UsernamePasswordAuthcodeAuthenticationToken.class
