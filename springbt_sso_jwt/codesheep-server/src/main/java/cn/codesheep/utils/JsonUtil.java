...
public class JsonUtil {
	 ...
	 * @throws JsonProcessingException
	 */
	public static String object2NonNullJsonStr(Object obj) throws JsonProcessingException {
		ObjectMapper mapper = local.get();
	...
	public static String get(String jsonStr,String fieldName) throws IOException {
		String rtnStr = null;
		try {
			JsonNode node= local.get().readTree(jsonStr);
