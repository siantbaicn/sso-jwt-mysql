...
export.keystoreFile = new File("/D:/rubin/jwt/mykey.jks");
export.keyStoreType = "JKS";
export.password = "123456".toCharArray();
export.alias = "mykey";
export.exportedPrivateKeyFile = new File("/D:/rubin/jwt/exported-pkcs8-mykey.key");
export.exportedPublicKeyFile = new File("/D:/rubin/jwt/exported-public-mykey.crt");
